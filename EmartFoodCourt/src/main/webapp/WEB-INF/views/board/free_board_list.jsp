			...
			<div class="free_container">
				...
				<div class="header">
					...
					<div id="header-two-1">
						...
						<c:choose>
							<c:when test="${board_orderby=='popularity'}">
								<a href="/EmartFoodCourt/boardList.bd?board_orderby=popularity&board_category=${board_category}"><img src="/EmartFoodCourt/resources/images/icon-hot-on@2x.png">&nbsp;인기</a>
							</c:when>
							<c:otherwise>
							<a href="/EmartFoodCourt/boardList.bd?board_orderby=popularity&board_category=${board_category}"><img src="/EmartFoodCourt/resources/images/icon-hot@2x.png">&nbsp;인기</a>
							</c:otherwise>
						</c:choose>
					...
					<c:choose>
							...
							<a href="/EmartFoodCourt/boardList.bd?board_orderby=new&board_category=${board_category}"><img src="/EmartFoodCourt/resources/images/icon-new-on@2x.png">&nbsp;최신</a>
							</c:when>
							<c:otherwise>
										...
										<c:when test="${free_board!=null}">			
											<c:forEach var="list" items="${free_board}">
												<div class="board_row">
													...
													<div class="cell col4">${list.board_readcount}</div>
													<div class="cell col5">
													<c:choose>
